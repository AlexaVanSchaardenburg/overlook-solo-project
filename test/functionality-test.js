...
describe(`Calculate the total spent by the user on bookings`, function() {
    ...
    it('Should return 0 if user has no bookings', function() {
        let userBookings3 = findUserBookings(user3, bookings)
...
describe(`Find available rooms on a specific date`, function() {
    it('Should return an array of rooms available given a date', function() {
        let availableRooms = findAvailableRooms('2022/04/22', bookings, rooms)
    ...
    it('Should return an array of rooms available given a different date', function() {
        let availableRooms = findAvailableRooms('2022/01/24', bookings, rooms)
    ...
    it('Should return a message if no rooms are avialable', function() {
        let availableRooms = findAvailableRooms('2022/01/01', bookings2, rooms)

        expect(availableRooms).to.equal(`It looks like there are no rooms available on 2022/01/01! Please select a different date :)`)
    });
});
...
describe(`Find rooms by type`, function() {
    ...
    let availableRooms
    beforeEach(function() {
        availableRooms = findAvailableRooms('2022/01/24', bookings, rooms)
    })
